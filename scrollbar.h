...
public:
    ...
    //int minSliderValue() const;
    //int maxSliderValue() const;
...
Q_SIGNALS:
    ...
    void sliderMoved(Qt::Orientation, int);
    void valueChanged(Qt::Orientation, int);

public Q_SLOTS:
    virtual void setBase( double min, double max );
    virtual void moveSlider( double min, double max );
    //virtual void moveSlider(int min, int max);
protected:
    void sliderRange( int value, double &min, double &max ) const;
    //void sliderRange(int value, int& min, int& max) const;

    int mapToTick( double ) const;
    double mapFromTick( int ) const;
    //int mapToTick(int) const;
    //int mapFromTick(int) const;
